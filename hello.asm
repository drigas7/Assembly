...
CBI DDRD, 2 ; DIGITAL PIN 2 AS INPUT WHICH IS INPUT P 
CBI DDRD, 3 ; DIGITAL PIN 3 AS INPUT WHICH IS INPUT Q
CBI DDRD, 4 ; DIGITAL PIN 4 AS INPUT WHICH IS INPUT R 
